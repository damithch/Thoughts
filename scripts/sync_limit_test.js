...
async function doRequests() {
  ...
  console.log('Posting to /api/rag/documents to sync + ingest (full ingestion)...');
  ...
  try {
    ...
    console.log('/api/rag/documents raw response:', text1.slice(0, 1000));
  }

  console.log('\nCalling /api/retrieval with query "mood" using synthetic embedding');
  ...
  console.log('\nCalling /api/rag/generate with question "What does my journal say about my mood?" (synthetic)');
